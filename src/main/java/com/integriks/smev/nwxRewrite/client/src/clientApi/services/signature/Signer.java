...
public interface Signer {
     ...
     * @param signature        подпись элемента
     * @param content2validate проверяемый элемент
     * @param callback         вызов по завершению валидации
     * @throws SMEVSignatureException в случае ошибки валидации, либо любых других
     */
    void validateSMEVSignature(Element signature, Element content2validate, PostValidationCallback callback)
            throws SMEVSignatureException;
