...
package com.integriks.smev.nwxRewrite.client.src.serverApi.autogenerated.types;
...
import com.integriks.smev.nwxRewrite.client.src.serverApi.autogenerated.types.basic.AttachmentHeaderList;
import com.integriks.smev.nwxRewrite.client.src.serverApi.autogenerated.types.basic.MessagePrimaryContent;
import com.integriks.smev.nwxRewrite.client.src.serverApi.autogenerated.types.basic.RefAttachmentHeaderList;
import com.integriks.smev.nwxRewrite.client.src.serverApi.autogenerated.types.basic.XMLDSigSignatureType;
 ...
 *         &lt;element name="To" type="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1}string-4000"/>
 *         &lt;choice>
 *           &lt;sequence>
 *             &lt;element ref="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1}MessagePrimaryContent"/>
 *             &lt;element name="PersonalSignature" type="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1}XMLDSigSignatureType" minOccurs="0"/>
 *             &lt;element ref="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1}AttachmentHeaderList" minOccurs="0"/>
 *             &lt;element ref="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1}RefAttachmentHeaderList" minOccurs="0"/>
 *           &lt;/sequence>
 ...
 *                 &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                   &lt;sequence>
 *                     &lt;element name="RejectionReasonCode" type="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/1.1}RejectCode"/>
 *                     &lt;element name="RejectionReasonDescription" type="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1}string-4000"/>
 *                   &lt;/sequence>
 *                 &lt;/restriction>
 *               &lt;/complexContent>
 *             &lt;/complexType>
 ...
 *                       &lt;/complexType>
 *                     &lt;/element>
 *                     &lt;element name="StatusDescription" type="{urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1}string-4000"/>
 *                   &lt;/sequence>
 *                 &lt;/restriction>
 *               &lt;/complexContent>
 *             &lt;/complexType>
...
public class SenderProvidedResponseData {
    ...
    protected String to;
    @XmlElement(name = "MessagePrimaryContent", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1")
    ...
    @XmlElement(name = "AttachmentHeaderList", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1")
    protected AttachmentHeaderList attachmentHeaderList;
    @XmlElement(name = "RefAttachmentHeaderList", namespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1")
